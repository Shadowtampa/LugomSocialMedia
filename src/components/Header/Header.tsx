...
export default function Header() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a href="/campaings" className="flex items-center">
          Promoções
        </a>
      </Typography>
      <Typography
        ...
        className="p-1 font-normal"
      >
        <a href=" /socials" className="flex items-center">
          Redes Sociais
        </a>
      </Typography>
    </ul>
  ...
  return (
    <div className="-m-6 max-h-[768px] w-[calc(100%+48px)] overflow-scroll">
      <Navbar
        className="sticky top-0 z-1 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4"
