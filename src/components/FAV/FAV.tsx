export const FavButton = () => {
    return (
        <div className="flex items-center justify-around">
            <div className="">
                <button
                    className="fixed bottom-20 right-40 text-white px-4 w-auto h-20 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none">
